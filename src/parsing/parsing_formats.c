...
const t_format	*get_plane_fmt(void)
{
	static const t_format	fmt[] = {
		...
		{ F_NVEC3, offsetof(t_obj, shape.plane.dir), \
			"dir (normalized)" },
		{ F_COLOR, offsetof(t_obj, color), "color" },
		{ F_END, 0, NULL }
	};
...
const t_format	*get_cylinder_fmt(void)
{
	static const t_format	fmt[] = {
		...
		{ F_NVEC3, offsetof(t_obj, shape.cylinder.dir), \
			"dir (normalized)" },
		{ F_DOUBLE, offsetof(t_obj, shape.cylinder.radius), "size" },
		{ F_DOUBLE, offsetof(t_obj, shape.cylinder.height), \
			"height" },
		{ F_COLOR, offsetof(t_obj, color), "color" },
		{ F_END, 0, NULL }
	};
